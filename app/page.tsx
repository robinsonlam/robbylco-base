  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-12">
      ...
      <div className="heroContainer container font-sans text-center flex flex-col gap-3 sm:gap-4">
        ...
        <p className="text-xs text-gray leading-relaxed">Currently <strong>open</strong> to <strong>contract,</strong> <strong>freelance</strong> and <strong>full-time lead engineering & manager</strong> opportunities</p>
